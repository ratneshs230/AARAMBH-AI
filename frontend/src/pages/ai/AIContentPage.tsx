  ...
  const contentTemplates = [
    {
      ...
      prompt: 'Create an interactive lesson about [topic] with learning objectives, explanations, and practice activities',
    },
    {
      title: 'Study Notes',
      description: 'Generate comprehensive study notes',
      prompt: 'Create detailed study notes covering all important concepts of [topic] with key points and examples',
    },
    {
      title: 'Practice Worksheets',
      description: 'Design practice exercises',
      prompt: 'Design a practice worksheet for [topic] with various types of questions and detailed solutions',
    },
    {
      title: 'Lab Experiment',
      description: 'Create hands-on experiments',
      prompt: 'Design a lab experiment to demonstrate [concept] with materials, procedure, and expected results',
    },
  ];
              ...
              <Grid container spacing={2}>
                  ...
                  <Accordion>
                    ...
                    <AccordionDetails>
                      <Typography variant="body2">
                        "Create a comprehensive lesson plan on photosynthesis for Class 10 students with learning objectives, explanations, diagrams, and activities"
                      </Typography>
                    </AccordionDetails>
                  </Accordion>
                </Grid>
                ...
                <Grid item xs={12} md={4}>
                  <Accordion>
                    ...
                    <AccordionDetails>
                      <Typography variant="body2">
                        "Generate detailed study notes for quadratic equations with step-by-step solutions, formulas, and practice problems"
                      </Typography>
                    </AccordionDetails>
                  </Accordion>
                </Grid>
                ...
                <Grid item xs={12} md={4}>
                  <Accordion>
                    ...
                    <AccordionDetails>
                      <Typography variant="body2">
                        "Design an interactive activity to teach the periodic table with games, mnemonics, and hands-on experiments"
                      </Typography>
                    </AccordionDetails>
                  </Accordion>
                </Grid>
