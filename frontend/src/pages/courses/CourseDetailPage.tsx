  ...
  chapters: [
    {
      ...
      isCompleted: true,
      lessons: [
        { id: 'l1', title: 'Introduction to Relations', duration: '45 min', type: 'video', isCompleted: true, isLocked: false },
        { id: 'l2', title: 'Types of Relations', duration: '30 min', type: 'video', isCompleted: true, isLocked: false },
        { id: 'l3', title: 'Functions and their Properties', duration: '50 min', type: 'video', isCompleted: true, isLocked: false },
        { id: 'l4', title: 'Practice Quiz', duration: '20 min', type: 'quiz', isCompleted: true, isLocked: false },
      ],
    },
    {
      id: 'ch2',
      ...
      isCompleted: false,
      lessons: [
        { id: 'l5', title: 'Basic Concepts', duration: '40 min', type: 'video', isCompleted: true, isLocked: false, preview: true },
        { id: 'l6', title: 'Properties and Identities', duration: '45 min', type: 'video', isCompleted: false, isLocked: false },
        { id: 'l7', title: 'Solving Equations', duration: '35 min', type: 'video', isCompleted: false, isLocked: false },
        { id: 'l8', title: 'Practice Problems', duration: '25 min', type: 'quiz', isCompleted: false, isLocked: false },
      ],
    },
    {
      id: 'ch3',
      ...
      isCompleted: false,
      lessons: [
        { id: 'l9', title: 'Introduction to Matrices', duration: '50 min', type: 'video', isCompleted: false, isLocked: true },
        { id: 'l10', title: 'Matrix Operations', duration: '60 min', type: 'video', isCompleted: false, isLocked: true },
        { id: 'l11', title: 'Determinants', duration: '55 min', type: 'video', isCompleted: false, isLocked: true },
        { id: 'l12', title: 'Matrix Assessment', duration: '30 min', type: 'quiz', isCompleted: false, isLocked: true },
      ],
    },
  ],
  learningOutcomes: [
            ...
            <CardContent>
              ...
              <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
                ...
                <Box sx={{ display: 'flex', alignItems: 'center' }}>
                  ...
                  <Typography variant="body2">{course.studentsEnrolled.toLocaleString()} students enrolled</Typography>
                </Box>
                <Box sx={{ display: 'flex', alignItems: 'center' }}>
